...
candidate_database = {
    "Lane": ["Lane", "0x9c6E5c2051b28a63813c8076d9B6cC63ce0a26B6", "4.3", .20, "Images/lane.jpeg"],
    "Ash": ["Ash", "0xc23c3C15E8c25796856f7C90BCc563f03F554Acf", "5.0", .33, "Images/ash.jpeg"],
    "Jo": ["Jo", "0x3d42FD46025a9D82d7A5ddb26dDaa0DfbA68b9ed", "4.7", .19, "Images/jo.jpeg"],
    "Kendall": ["Kendall", "0x076F8EfA595B55A208AE795863175621A1B5DA86", "4.1", .16, "Images/kendall.jpeg"]
}
...
if st.sidebar.button("Send Transaction"):
    ...
    transaction_hash = send_transaction(account=account, to=candidate_address, wage=wage)
